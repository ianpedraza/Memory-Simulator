...
public class ControlPanel extends JFrame 
{
  ...
  Label pageValueLabel = new Label("NONE" , Label.LEFT) ;
  Label segmentValueLabel = new Label("NONE", Label.LEFT) ;
  ...
  public void init( Kernel useKernel , String commands , String config ) 
  {
    ...
    pageValueLabel.reshape( 395,250+25,200,15 );
    add( pageValueLabel );

    segmentValueLabel.reshape( 395,265+25,200,15 );
    add( segmentValueLabel );
    ...
    Label pageLabel = new Label("page: " , Label.LEFT) ;
    pageLabel.reshape(285,250+25,110,15);
    add(pageLabel);

    Label segmentLabel = new Label("segment: " , Label.LEFT) ;
    segmentLabel.reshape(285,265+25,110,15);
    add(segmentLabel);
  ...
  public void paintPage( Page page ) 
  {
    ...
    //pageValueLabel.setText( page.initialSegment != -1 ? Long.toString( page.initialSegment) : "NONE" );
    pageValueLabel.setText( Integer.toString(page.id) );
    segmentValueLabel.setText(page.segments);
  }
